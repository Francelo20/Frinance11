    ...
    for(let cont=0; cont<=listart.length-1; cont++){
        ...
        async function chamar(limit){
            ...
            if(colec[cont].rod<2){
                ...
                console.log(`OK SETANDO rmaxt = ${colec[cont].rmaxt} MES NO intervalo 1M ${colec[cont].int} rodada 0-1 ${colec[cont].rod}`)
            }
            ...
            limit =parseInt(list[0].mes) // -1 tirando 1 ou 2 do Maximo p proxima chamada
            if(parseInt(limit)>=3){        // >=2 chegando a chamada até num minimo de velas
                chamar(limit)
            }else{
                ...
                console.log('..............................................')
                console.log(`Crypto: ${colec[8].val}  Intervalos:${listart.length}  Rodadas:${colec[8].rod} Atual: ${list[2].val}`)
                console.log(`json: {"cryp":"${symboll}", "sup":[${tentsort}], "qualymes":[${colec[0].val}], "rmaxt": ${colec[0].rmaxt}}`)
